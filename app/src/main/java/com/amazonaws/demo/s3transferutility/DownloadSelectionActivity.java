...
public class DownloadSelectionActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initData();
        initUI();
        Log.d("Amazon", "Aqui en el oncreate de DSelection ");
    }
    ...
    private void initData() {
        ...
        Log.d("Amazon", "Aqui en initData ");
        s3 = Util.getS3Client(DownloadSelectionActivity.this);
        transferRecordMaps = new ArrayList<HashMap<String, Object>>();
        Log.d("Amazon", "Aqui salió del initData " + s3);
    }

    private void initUI() {

        Log.d("Amazon", "Aqui en initUI del adapter ");
    ...
    private class GetFileListTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            Log.d("Amazon", "Aqui en preexecute ");
        }
        ...
        protected Void doInBackground(Void... inputs) {
            ...
            Log.d("Amazon", "Aqui en el comienzo del doInbackgroud " + Constants.BUCKET_NAME + s3);
            ObjectListing s3ListNude = s3.listObjects("com.radiolobetest");

            //s3ObjList = s3.listObjects(Constants.BUCKET_NAME).getObjectSummaries();

            Log.d("Amazon", "Aqui doInBackGround  " + s3ListNude);

            s3ObjList = s3ListNude.getObjectSummaries();
            transferRecordMaps.clear();

            for (S3ObjectSummary summary : s3ObjList) {
                HashMap<String, Object> map = new HashMap<String, Object>();
                Log.d("Amazon", "Aqui en el doingBackground " + summary.getKey());
